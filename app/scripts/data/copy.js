...
export const servicesPage = {
	strategy: [
		...
		<li key="7">Tell <span className="red-emphasis-words">your story</span> with creative and differentiated marketing</li>,
		<li key="8">Develop <span className="red-emphasis-words">personas</span> targeting your audience</li>,
		<li key="9">Create effective marketing <span className="red-emphasis-words">actions and KPIS</span></li>,
